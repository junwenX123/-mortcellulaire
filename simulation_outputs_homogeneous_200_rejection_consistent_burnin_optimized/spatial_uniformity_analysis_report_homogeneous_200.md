...
```latex
CV_{uniform} \approx \sqrt{\frac{k-1}{n}}.
```
...
| scenario | time for analyzed 200 deaths | death rejection rate | CV ratio to uniform | chi2/df | p-value | empty bins |
|---|---:|---:|---:|---:|---:|---:|
| baseline | 40.746 | 0.735 | 1.181 | 1.677 | 0.0201 | 18 |
| higher_death_intensity | 18.916 | 0.734 | 0.974 | 1.479 | 0.0613 | 17 |
| stronger_ERK_protection | 41.917 | 0.846 | 0.882 | 0.979 | 0.49 | 8 |
| stronger_activation_feedback | 15.692 | 0.608 | 1.059 | 1.135 | 0.293 | 15 |
| weaker_ERK_optimized | 15.794 | 0.541 | 1.005 | 1.604 | 0.0308 | 17 |
...
The fastest scenario is `stronger_activation_feedback`, with 15.692 time units for the analyzed 200 deaths.
